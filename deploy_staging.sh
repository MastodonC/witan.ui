...
STATUS=$(curl -s -o /dev/null -w "%{http_code}" -X POST http://***REMOVED***:9501/marathon/witan-ui -H "Content-Type: application/json" -H "$SEKRIT_HEADER: 123" --data-binary "@witan-ui.json")
