...
(def strings
  {:witan                          "Witan"
   ...
   :input                          "Input"
   :input-intro                    "To generate your forecast, choose which data should go into your model from the options below. You can upload your own data, or choose from any datasets already in the system."
   :model-intro                    "Your forecast feeds your chosen input data into the model to below to generate your data. Download it at the next step."
   :output                         "Output"
