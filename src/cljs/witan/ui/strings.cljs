...
(def strings
  {:string/name                           "Name"
   ...
   :string/forecast-in-progress-text      "We're currently building a new version of this projection for you. You can download your new datasets from the 'Output' section when this message disappears."
   ...
   :string/browser-upload-select-existing "Please select the existing dataset that you want to update"
   :string/use-data-item                  "Use"
   :string/pw-input-brief                 "Choose your input data"
   :string/confirm-email                  "Confirm email"
   :string/input-intro                    "To generate your projection, choose which dataset should go into your model from the options below. You can upload your own data, or choose from any datasets already in the system."
   :string/witan                          "Witan"
   ...
   :string/upload-data-public-warning     "As this is a public projection, any dataset you upload will also become public."
   ...
   :string/browser-no-file-selected       "No dataset selected..."
   :string/witan-title                    "Witan for London"
   :string/help                           "Help"
   :string/no-input-specified             "No dataset input specified."
   ...
   :string/please-select-data-input       "Please select a dataset for this category."
   ...
   :string/browser-upload-option-existing "This is an updated version of an existing dataset"
   :string/pw-output-brief                "Download your dataset"
   :string/input                          "Input"
   :string/output-intro                   "Once the model's calculations have been completed and your output dataset is available, you will be able to download it here. "
   ...
   :string/model-intro                    "Your projection feeds your chosen input datasets into the model to below to generate your data. Download it at the next step."
   ...
   :string/email                          "Email"
   :string/missing-required-inputs        "Some inputs are still missing datasets. Before you can save this projection, please select or upload appropriate datasets for the corresponding inputs."
   ...
   :string/browser-upload-option-new      "This is a brand new dataset"
   :string/browser-upload-select-new      "Please enter a name for the new dataset"
   ...
   :string/upload-data-public-explain     "Tick this box to make the dataset visible to everyone (public)"
   ...
   :string/browser-choose-data            "Choose from an existing dataset or upload your own new dataset"
   :string/new-version-no-downloads       "Once you have run your first projection, new datasets will be available here. Start this at the 'Inputs' section"
   ...
   :string/data-upload-step-3-group-heading "This dataset will be shared with %s user/group(s):"
