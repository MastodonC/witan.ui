...
(def strings
  {:string/support-email                    "witan@mastodonc.com"
   ...
   :string/data-dash-title                  "Dashboard"
   ...
   :string/file-sharing-meta-read           "Read"
   :string/file-sharing-meta-update         "Edit"
   :string/file-sharing-file-read           "Download"
   ...
   :string/title-data-dashboard             "Your Dashboard"
